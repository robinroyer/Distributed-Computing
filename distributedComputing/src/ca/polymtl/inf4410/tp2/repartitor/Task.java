...
public class Task {
	 ...
	 * 
	 * @param server
	 *            server that had perform the first calculation
	 * @param calculous
	 *            List of calculation proceed by the first server
	 * @param result
	 *            Result of the first calculation by the first server
	 * @param operationNumber
	 *            Number of operation proceed in the first calculation
	 */
	 ...
	 * 
	 * @param result
	 *            actual result to add
	 * @param list
	 *            list of calculous coresponding to that result
	 * @param numberOfOperations
	 *            number of operation proceed
	 */
	 ...
	 * 
	 * @param server
	 *            CalculousServerInterface that we want to check
	 ...
	 */
	public int getInitialOperationNumber() {
		return operationNumberToCheck;
	}
	 ...
	 * 
	 * @param server
	 *            the server the task is attribute to
	 */
	 ...
	 */
	public ArrayList<String> getCalculousList() {
		return calculousList;
	}

	/**
	 * Asking the task a number of calculous that will be remove from
	 * calculousToCheck getCalculous will return less than nextCapacity if
	 * calculousToCheck is empty
	 * 
	 * @param nextCapacity
	 *            number of operation asked
